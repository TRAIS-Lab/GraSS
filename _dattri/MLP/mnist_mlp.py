"""This module contains functions for MLP training/evaluation on the MNIST dataset."""
...
from .mlp import MLPMnist, create_mlp_model
...
def train_mnist_mlp(
    ...
    model = create_mlp_model("mnist", activation_fn=activation_fn)
...
def loss_mnist_mlp(
    ...
    model = create_mlp_model("mnist", activation_fn="relu")
