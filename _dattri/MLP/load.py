...
from _dattri.MLP.mnist_mlp import create_mlp_model, train_mnist_mlp
...
MODEL_MAP = {
    "mnist_mlp_relu": partial(create_mlp_model, "mnist", activation_fn="relu"),
    "mnist_mlp_sigmoid": partial(create_mlp_model, "mnist", activation_fn="sigmoid"),
    "mnist_mlp_tanh": partial(create_mlp_model, "mnist", activation_fn="tanh"),
    "mnist_mlp_leaky_relu": partial(create_mlp_model, "mnist", activation_fn="leaky_relu"),
    "mnist_mlp_linear": partial(create_mlp_model, "mnist", activation_fn="linear"),
}
