...
def main() -> None:
    ...
    :return: None
    """
    argparser = argparse.ArgumentParser(description="Retrain models on various datasets.")
    ...
    argparser.add_argument("--seed", type=int, default=0, help="The seed for retraining.")
    argparser.add_argument(
        "--partition",
        type=partition_type,
        default=[0, None, None],
